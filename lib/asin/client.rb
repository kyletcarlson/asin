...
#   lookup(asin, :ResponseGroup => :Large)
#
# == Cart
#
...
module ASIN
  module Client
    ...
    def search(params={:SearchIndex => :Books, :ResponseGroup => :Large})
      ...
      response['ItemSearchResponse']['IsValid'] = response['ItemSearchResponse']['Items']['Request']['IsValid'] 
    ...
    # ResponseGroup=NewReleases,TopSellers,MostWishedFor,MostGifted
    ...
    #
    def similar(*asins)
      params = asins.last.is_a?(Hash) ? asins.pop : {:SimilarityType => :Random, :ResponseGroup => :Large}
